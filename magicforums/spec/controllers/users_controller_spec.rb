...
before(:all) do
    @user = User.create(email: "test@email.com", username: "test1", password: "12345")
    @unauthorized_user = User.create(email: "test2@gmail.com", username: "test2", password: "67891")
  end
...
describe "create user" do
  it "should create new user" do
    ...
    expect(flash[:success]).to eql("YOU'VE HAVE SUCCESSFULLY CREATED AN ACCOUNT")
  end
end
